...
<form action="{{ route('team.update',$team) }}" method="POST" enctype="multipart/form-data" class="row">
    ...
    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="bg-white p-4 shadow-sm rounded">
            <h3 class="mb-4">Editar Membro: {{ $team->name }}</h3>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="6">{{ $team->description }}</textarea>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="url" name="instagram" class="form-control" value="{{ $team->instagram }}" placeholder="https://instagram.com/perfil">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label><i class="fab fa-facebook text-primary"></i> Facebook (URL)</label>
                        <input type="url" name="facebook" class="form-control" value="{{ $team->facebook }}" placeholder="https://facebook.com/perfil">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label><i class="fab fa-twitter text-info"></i> Twitter / X (URL)</label>
                        <input type="url" name="twitter" class="form-control" value="{{ $team->twitter }}" placeholder="https://twitter.com/perfil">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label><i class="fab fa-youtube text-danger"></i> YouTube (URL)</label>
                        <input type="url" name="youtube" class="form-control" value="{{ $team->youtube }}" placeholder="https://youtube.com/canal">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <label><i class="fab fa-whatsapp text-success"></i> WhatsApp (Número com DDD)</label>
                        <input type="text" name="whatsapp" class="form-control" value="{{ $team->whatsapp }}" placeholder="Ex: 11999999999 (apenas números)">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="form-group bg-white shadow-sm p-4 rounded">
            ...
            <a href="{{ route('team.index') }}" class="btn btn-outline-secondary btn-block mt-2">Voltar</a>
        </div>

        <div class="form-group my-4 bg-white shadow-sm p-4 rounded">
            <label><strong>Foto Atual</strong></label>
            <div class="border p-2 text-center mb-3 bg-light">
                <img src="{{ photon_thumbnail($team->thumbnail) }}" class="img-fluid rounded shadow-sm" style="max-height: 250px;">
            </div>
